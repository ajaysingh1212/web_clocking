<?php $__env->startSection('title', 'Login | EEMOT Clocking PWA'); ?>
...
<div class="login-wrap">
    ...
    <div class="login-panel-outer">
        <div class="login-panel">
            ...
            <form method="POST" action="<?php echo e(route('login.store')); ?>" class="needs-loader" novalidate>
                <?php echo csrf_field(); ?>

                <div class="field-group">
                    <div class="input-wrap">
                        <span class="material-symbols-rounded icon-left">mail</span>
                        <input id="email" name="email" type="email" value="<?php echo e(old('email')); ?>" class="form-control" required autofocus placeholder=" ">
                ...
                <div class="remember-row">
                    <div class="remember-check">
                        <input type="checkbox" name="remember" value="1" id="remember" <?php if(old('remember')): echo 'checked'; endif; ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\Documents\dev_clock\resources\views/auth/login.blade.php ENDPATH**/ ?>