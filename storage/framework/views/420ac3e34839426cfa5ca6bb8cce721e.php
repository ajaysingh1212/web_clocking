...
<?php $__env->startSection('title', 'Email Reports | EEMOT Clocking PWA'); ?>
...
<div class="docs-shell">
    ...
    <section class="docs-panel">
        ...
        <form method="POST" action="<?php echo e(route('settings.email-reports.send')); ?>" id="emailReportForm">
            <?php echo csrf_field(); ?>
            <div class="form-grid">
                <div class="form-field">
                    <label for="report_type">Select Report</label>
                    <select id="report_type" name="report_type" required class="styled-select">
                        <option value="attendance" <?php echo e(old('report_type') === 'attendance' ? 'selected' : ''); ?>>Monthly Attendance Sheet</option>
                        <option value="salary" <?php echo e(old('report_type') === 'salary' ? 'selected' : ''); ?>>Salary Slip (coming soon)</option>
                    </select>
                </div>
                ...
                <div class="form-field">
                    ...
                    <div id="monthContainer">
                        <input id="month" type="month" name="month" value="<?php echo e(old('month', $defaultMonth)); ?>" required>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WebProjects\web_clocking\resources\views/settings/email_reports.blade.php ENDPATH**/ ?>