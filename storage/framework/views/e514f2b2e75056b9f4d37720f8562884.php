...
<?php $__env->startSection('title', 'Manual Attendance | EEMOT Clocking PWA'); ?>
...
<form method="POST" action="<?php echo e(route('developer.mark-attendance.store')); ?>" enctype="multipart/form-data" class="needs-loader punch-form" id="punch-form">
    <?php echo csrf_field(); ?>
    ...
    <section class="punch-panel">
        ...
        <div class="fields-card">
            <div class="field">
                <span>User ID</span>
                <input id="user_id" name="user_id" type="text" class="ghost-input" value="<?php echo e(old('user_id', authUserId())); ?>" required>
            </div>

            <div class="field">
                <span>Date</span>
                <input id="date" name="date" type="date" class="ghost-input" value="<?php echo e(old('date', date('Y-m-d'))); ?>" required>
            </div>

            <div class="field">
                <span>Action</span>
                <select id="action" name="action" class="ghost-input" required>
                    <option value="" disabled <?php echo e(old('action') ? '' : 'selected'); ?>>Select action</option>
                    <option value="in" <?php echo e(old('action') === 'in' ? 'selected' : ''); ?>>In</option>
                    <option value="out" <?php echo e(old('action') === 'out' ? 'selected' : ''); ?>>Out</option>
                </select>
            </div>

            <div class="field">
                <span>Time</span>
                <input id="time" name="time" type="time" class="ghost-input" value="<?php echo e(old('time', date('H:i'))); ?>" required>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WebProjects\web_clocking\resources\views/attendance/manual.blade.php ENDPATH**/ ?>